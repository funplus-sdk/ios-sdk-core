...
public class FunPlusConfig {
    ...
    init(appId: String, appKey: String, rumTag: String, rumKey: String, environment: SDKEnvironment) {
        ...
        self.loggerUploadInterval = environment == .sandbox ? 10 : 60       // 10 sec / 60 sec
        
        self.rumEndpoint = FunPlusConfig.LOG_SERVER
        self.rumTag = rumTag
        self.rumKey = rumKey
        self.rumUploadInterval = environment == .sandbox ? 1 : 10           // 1 sec / 10 sec
        ...
        self.dataTag = appId
        self.dataKey = appKey
        self.dataUploadInterval = environment == .sandbox ? 1 : 10          // 1 sec / 10 sec
    }
